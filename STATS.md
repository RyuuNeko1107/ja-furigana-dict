...
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **600** | **40 KB** |
...
| [`core/works/anime/haikyu.toml`](core/works/anime/haikyu.toml) | 4 | 476 B | ハイキュー!! (古舘春一): キャラクター名 (公式読みベース) |
...
**合計**: should_read 1901 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
