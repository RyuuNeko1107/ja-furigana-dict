...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **8,216** | **276 KB** |
...
| [`core/jukugo/nature/body_parts.toml`](core/jukugo/nature/body_parts.toml) | 165 | 5.1 KB | 体の部位 / 内臓 / 骨格 / 筋肉 / 神経 |
| [`core/jukugo/nature/foods.toml`](core/jukugo/nature/foods.toml) | 150 | 4.4 KB | 食べ物 / 料理 / 和菓子 / 郷土料理 / 食材 / 調味料 |
| **小計** (6 ファイル) | **1,039** | **31 KB** | |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 4,117 | 143 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 183 | 7.6 KB | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (2 ファイル) | **4,300** | **150 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,767 | 3,568 | 183 KB | 単漢字 default override + 文脈分岐 reading |
