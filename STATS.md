...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,337** | **226 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **995** | **73 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 214 | 16 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| [`core/jukugo/humanities/shinwa.toml`](core/jukugo/humanities/shinwa.toml) | 31 | 1.4 KB | (用途未設定 — ファイル冒頭に `[meta] description = "..."` を追加) |
...
| [`core/jukugo/humanities/folklore.toml`](core/jukugo/humanities/folklore.toml) | 11 | 789 B | (用途未設定 — ファイル冒頭に `[meta] description = "..."` を追加) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 135 | 9.8 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
...
| [`core/works/game/sangokushi.toml`](core/works/game/sangokushi.toml) | 31 | 2.0 KB | 三国志 (演義/ゲーム/漫画): 武将名 (日本語音読み) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/vtuber/nijisanji.toml`](core/works/vtuber/nijisanji.toml) | 46 | 3.8 KB | にじさんじ (ANYCOLOR): ライバー名 (公式読みベース) |
| [`core/works/vtuber/hololive.toml`](core/works/vtuber/hololive.toml) | 33 | 2.8 KB | ホロライブプロダクション (カバー): タレント名 (公式読みベース) |
...
**合計**: should_read 2098 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
