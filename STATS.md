...
| [**外来語**](#外来語) (`core/loanwords/*`、IT 用語等の英字 surface) | **808** | **22 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/loanwords/general.toml`](core/loanwords/general.toml) | 622 | 16 KB | 一般英語 / メディア / ゲーミング / SNS 略語 (ASCII surface) |
...
**合計**: should_read 1454 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
