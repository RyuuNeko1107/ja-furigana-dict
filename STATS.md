...
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **1,633** | **125 KB** |
...
| [`core/works/anime/toaru.toml`](core/works/anime/toaru.toml) | 27 | 2.7 KB | とある魔術の禁書目録 / 超電磁砲 (鎌池和馬): キャラクター名 |
...
| [`core/works/anime/kingdom.toml`](core/works/anime/kingdom.toml) | 20 | 1.5 KB | キングダム (原泰久): キャラクター名 (古代中国名の難読読み) |
