...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **2,969** | **156 KB** |
...
| [`core/jukugo/basic/stream_round_20260526.toml`](core/jukugo/basic/stream_round_20260526.toml) | 35 | 1.2 KB | VV stream-comments comparison round (seed=20260526) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 15 | 729 B | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (3 ファイル) | **2,079** | **119 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,770 | 3,600 | 181 KB | 単漢字 default override + 文脈分岐 reading |
