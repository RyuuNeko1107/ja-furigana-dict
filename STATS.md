...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,240** | **219 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **738** | **52 KB** |
...
| [`core/jukugo/nature/foods.toml`](core/jukugo/nature/foods.toml) | 102 | 4.3 KB | 食べ物 / 料理 / 和菓子 / 郷土料理 / 食材 / 調味料 |
...
**合計**: 738 件 / 52 KB (genre 4 区分)

#### ゲーム

ゲーム作品の固有名詞 (キャラクター / 場所 / 用語、 公式読みベース)

`core/works/game/` — 14 ファイル
...
**合計**: should_read 1980 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
