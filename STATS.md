...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,900** | **205 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **560** | **37 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 182 | 14 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
**合計**: 560 件 / 37 KB (genre 4 区分)

#### ゲーム

ゲーム作品の固有名詞 (キャラクター / 場所 / 用語、 公式読みベース)

`core/works/game/` — 12 ファイル
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/anime/bleach.toml`](core/works/anime/bleach.toml) | 16 | 1.5 KB | BLEACH (久保帯人) キャラ名・用語 |
...
| [`core/works/anime/naruto.toml`](core/works/anime/naruto.toml) | 2 | 307 B | NARUTO (岸本斉史): キャラクター名 (公式読みベース) |
...
**合計**: should_read 1856 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
