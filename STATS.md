...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,494** | **174 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **394** | **20 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/foods.toml`](core/jukugo/nature/foods.toml) | 90 | 3.3 KB | 食べ物 / 料理 / 和菓子 / 郷土料理 / 食材 / 調味料 |
...
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 42 | 1.8 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/humanities/arts.toml`](core/jukugo/humanities/arts.toml) | 58 | 2.2 KB | 古典芸能 / 武道 / 茶華香 / 工芸 |
| [`core/jukugo/humanities/literature.toml`](core/jukugo/humanities/literature.toml) | 49 | 2.2 KB | 古典文学 / 作品名 / 文学用語 / 詩歌 / 評論 |
| [`core/jukugo/humanities/religions.toml`](core/jukugo/humanities/religions.toml) | 47 | 1.9 KB | 神道 / 仏教 / キリスト教 / イスラム / 儀礼 |
| [`core/jukugo/humanities/idioms.toml`](core/jukugo/humanities/idioms.toml) | 42 | 2.7 KB | 慣用句 / ことわざ / 故事成語 (フレーズ単位) |
| [`core/jukugo/humanities/music.toml`](core/jukugo/humanities/music.toml) | 22 | 1.1 KB | 音楽ジャンル / 楽典 / 楽器 / 演奏 / 音楽用語 |
| [`core/jukugo/humanities/abstracts.toml`](core/jukugo/humanities/abstracts.toml) | 18 | 774 B | 美意識 / 古典文学 / 仏教 / 儒教 / 思想 |
| [`core/jukugo/humanities/emotions.toml`](core/jukugo/humanities/emotions.toml) | 9 | 536 B | 感情 / 心理状態 / 性格 / 心情 |
| **小計** (7 ファイル) | **245** | **11 KB** | |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/society/specialized.toml`](core/jukugo/society/specialized.toml) | 67 | 3.9 KB | 専門用語 (医学 / 軍事 / 法学 / 経済 / IT / 工学) |
| [`core/jukugo/society/sports.toml`](core/jukugo/society/sports.toml) | 28 | 1.4 KB | 近代スポーツ / 球技 / 陸上 / 水泳 / 体操 / 大会 |
| [`core/jukugo/society/finance.toml`](core/jukugo/society/finance.toml) | 18 | 1.3 KB | 経済金融 (商品 / 市場 / 会計 / 税務 / 保険) |
| [`core/jukugo/society/politics.toml`](core/jukugo/society/politics.toml) | 8 | 685 B | 政治 / 行政 / 立法 / 司法 / 国際関係 |
| **小計** (4 ファイル) | **121** | **7.2 KB** | |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 72 | 4.5 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
| [`core/jukugo/proper/proper_nouns.toml`](core/jukugo/proper/proper_nouns.toml) | 30 | 1.5 KB | 固有名詞 (大学 / 中央官庁 / 元号 / 歴史的事象、PR 募集中) |
| **小計** (2 ファイル) | **102** | **5.9 KB** | |
...
`core/jukugo/basic/` — 4 ファイル

| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,427 | 125 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
| [`core/jukugo/basic/stream_round_20260611.toml`](core/jukugo/basic/stream_round_20260611.toml) | 26 | 2.4 KB | VV stream-comments comparison round (seed=20260611) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 15 | 729 B | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (4 ファイル) | **2,507** | **130 KB** | |
...
**合計**: 394 件 / 20 KB (genre 4 区分)

#### ゲーム

ゲーム作品の固有名詞 (キャラクター / 場所 / 用語、 公式読みベース)

`core/works/game/` — 2 ファイル
...
`core/works/anime/` — 14 ファイル

| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/anime/bleach.toml`](core/works/anime/bleach.toml) | 13 | 1.3 KB | BLEACH (久保帯人) キャラ名・用語 |
| [`core/works/anime/jujutsu.toml`](core/works/anime/jujutsu.toml) | 11 | 1016 B | 呪術廻戦 (芥見下々): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/jojo.toml`](core/works/anime/jojo.toml) | 10 | 1.2 KB | ジョジョの奇妙な冒険 (荒木飛呂彦): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/kimetsu.toml`](core/works/anime/kimetsu.toml) | 6 | 771 B | 鬼滅の刃 (吾峠呼世晴): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/conan.toml`](core/works/anime/conan.toml) | 4 | 486 B | 名探偵コナン (青山剛昌): キャラクター名 (公式読みベース) |
| [`core/works/anime/gintama.toml`](core/works/anime/gintama.toml) | 4 | 531 B | 銀魂 (空知英秋): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/tokyo_revengers.toml`](core/works/anime/tokyo_revengers.toml) | 3 | 404 B | 東京卍リベンジャーズ (和久井健): キャラクター名 (公式読みベース) |
| [`core/works/anime/dragonball.toml`](core/works/anime/dragonball.toml) | 2 | 288 B | ドラゴンボール (鳥山明): キャラクター名 (公式読みベース) |
| [`core/works/anime/haikyu.toml`](core/works/anime/haikyu.toml) | 2 | 300 B | ハイキュー!! (古舘春一): キャラクター名 (公式読みベース) |
...
| [`core/works/anime/naruto.toml`](core/works/anime/naruto.toml) | 1 | 225 B | NARUTO (岸本斉史): キャラクター名 (公式読みベース) |
| **小計** (14 ファイル) | **60** | **7.4 KB** | |

#### VTuber

VTuber の名前 (姓・フルネーム、 公式読みベース)

`core/works/vtuber/` — 2 ファイル

| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/vtuber/hololive.toml`](core/works/vtuber/hololive.toml) | 18 | 1.5 KB | ホロライブプロダクション (カバー): タレント名 (公式読みベース) |
| [`core/works/vtuber/nijisanji.toml`](core/works/vtuber/nijisanji.toml) | 3 | 374 B | にじさんじ (ANYCOLOR): ライバー名 (公式読みベース) |
| **小計** (2 ファイル) | **21** | **1.9 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,591 | 180 KB | 単漢字 default override + 文脈分岐 reading |
...
|---|---:|---:|---:|---|
| [`rules/numbers/counters/simple.toml`](rules/numbers/counters/simple.toml) | 77 | 77 | 1.7 KB | 単純サフィックス助数詞 (円 / 点 / 度 / 名 / 話 等、 数値カナ + value 連結のみ) |
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 28 | 63 | 5.8 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
...
| [`rules/numbers/counters/time.toml`](rules/numbers/counters/time.toml) | 11 | 15 | 1.5 KB | 時間系助数詞 (月 / 日 / 時 / 分 / 週間 / 回、 4/7/9 の特殊読み + カナ末尾置換) |
| [`rules/numbers/counters/places.toml`](rules/numbers/counters/places.toml) | 4 | 9 | 720 B | 場所を数える助数詞 (階 / ヶ所 / 箇所 / か所、 連濁 / 促音化) |
...
**合計**: should_read 1029 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース

| バケット | ファイル | ケース数 |
|---|---|---:|
| `should_read` | [`tests/corpus/should_read/corpus_2026_06_12.toml`](tests/corpus/should_read/corpus_2026_06_12.toml) | 39 |
...
|  | [`tests/corpus/should_read/regression.toml`](tests/corpus/should_read/regression.toml) | 499 |
