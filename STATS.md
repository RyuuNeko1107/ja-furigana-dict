...
| **熟語** (`core/jukugo/*`、手動 PR メンテ) | **4,616** | **187 KB** |
...
| `core/jukugo/general.toml` | 783 | 23 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
| `core/jukugo/weather.toml` | 189 | 6.5 KB | 気象 / 天候 / 季語的気象 / 二十四節気 / 海洋気象 |
| `core/jukugo/science.toml` | 186 | 7.0 KB | 自然科学 (天文 / 物理 / 化学 / 生物 / 地学) |
| `core/jukugo/animals.toml` | 185 | 5.9 KB | 動植物 / 魚介 / 鳥 / 昆虫 / 茸 / 海藻の難読 |
| `core/jukugo/music.toml` | 180 | 10 KB | 音楽ジャンル / 楽典 / 楽器 / 演奏 / 音楽用語 |
| `core/jukugo/clothes.toml` | 169 | 5.1 KB | 衣服 / 装束 / アクセサリー / 履物 |
...
| **小計** | **48,926** | **997 KB** | (jukugo: 24 ファイル / **4,616 件** / 187 KB ・ works: 1 ファイル / **72 件** / 4.5 KB) |
