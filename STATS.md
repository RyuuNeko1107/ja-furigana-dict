...
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **687** | **48 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/anime/kimetsu.toml`](core/works/anime/kimetsu.toml) | 30 | 2.7 KB | 鬼滅の刃 (吾峠呼世晴): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/jojo.toml`](core/works/anime/jojo.toml) | 23 | 2.4 KB | ジョジョの奇妙な冒険 (荒木飛呂彦): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/jujutsu.toml`](core/works/anime/jujutsu.toml) | 23 | 2.0 KB | 呪術廻戦 (芥見下々): キャラクター名 / 用語 (公式読みベース) |
...
**合計**: should_read 1953 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
