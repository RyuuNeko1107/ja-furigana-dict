...
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **1,172** | **87 KB** |
...
| [`core/works/game/gyakuten.toml`](core/works/game/gyakuten.toml) | 7 | 640 B | 逆転裁判: キャラクター名 |
...
**合計**: should_read 2190 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
