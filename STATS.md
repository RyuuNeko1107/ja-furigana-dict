...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,232** | **219 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **697** | **49 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 213 | 16 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
| [`core/jukugo/nature/foods.toml`](core/jukugo/nature/foods.toml) | 94 | 3.7 KB | 食べ物 / 料理 / 和菓子 / 郷土料理 / 食材 / 調味料 |
...
| [`core/jukugo/humanities/religions.toml`](core/jukugo/humanities/religions.toml) | 55 | 2.6 KB | 神道 / 仏教 / キリスト教 / イスラム / 儀礼 |
...
| [`core/jukugo/society/sports.toml`](core/jukugo/society/sports.toml) | 32 | 1.8 KB | 近代スポーツ / 球技 / 陸上 / 水泳 / 体操 / 大会 |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 103 | 7.3 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
| [`core/jukugo/proper/surnames.toml`](core/jukugo/proper/surnames.toml) | 38 | 1.2 KB | 難読姓 (苗字) の読み (姓単体、代表読み) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,595 | 136 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 30 | 1.9 KB | 四字熟語 (4 字 + 全 CJK 漢字) |
...
**合計**: 697 件 / 49 KB (genre 4 区分)

#### ゲーム

ゲーム作品の固有名詞 (キャラクター / 場所 / 用語、 公式読みベース)

`core/works/game/` — 13 ファイル
...
| [`core/works/game/sangokushi.toml`](core/works/game/sangokushi.toml) | 19 | 1.4 KB | 三国志 (演義/ゲーム/漫画): 武将名 (日本語音読み) |
| [`core/works/game/idolmaster.toml`](core/works/game/idolmaster.toml) | 11 | 1.0 KB | アイドルマスター (バンダイナムコ): キャラクター名 |
| [`core/works/game/bluearchive.toml`](core/works/game/bluearchive.toml) | 10 | 881 B | ブルーアーカイブ (Nexon/Yostar): キャラクター名 (公式読みベース) |
| [`core/works/game/persona.toml`](core/works/game/persona.toml) | 9 | 896 B | ペルソナ (アトラス): キャラクター名 |
| [`core/works/game/honkai_starrail.toml`](core/works/game/honkai_starrail.toml) | 6 | 600 B | 崩壊:スターレイル (HoYoverse): キャラクター名 (公式日本語読みベース) |
| [`core/works/game/fate.toml`](core/works/game/fate.toml) | 4 | 466 B | Fate / 型月 (TYPE-MOON): キャラクター名 |
| [`core/works/game/lovelive.toml`](core/works/game/lovelive.toml) | 4 | 449 B | ラブライブ! (サンライズ): キャラクター名 |
| [`core/works/game/touken_ranbu.toml`](core/works/game/touken_ranbu.toml) | 3 | 431 B | 刀剣乱舞 (ニトロプラス): 刀剣男士名 |
...
`core/works/anime/` — 36 ファイル

| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/anime/kimetsu.toml`](core/works/anime/kimetsu.toml) | 35 | 3.1 KB | 鬼滅の刃 (吾峠呼世晴): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/jujutsu.toml`](core/works/anime/jujutsu.toml) | 28 | 2.4 KB | 呪術廻戦 (芥見下々): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/jojo.toml`](core/works/anime/jojo.toml) | 23 | 2.4 KB | ジョジョの奇妙な冒険 (荒木飛呂彦): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/bleach.toml`](core/works/anime/bleach.toml) | 19 | 1.8 KB | BLEACH (久保帯人) キャラ名・用語 |
| [`core/works/anime/haikyu.toml`](core/works/anime/haikyu.toml) | 17 | 1.6 KB | ハイキュー!! (古舘春一): キャラクター名 (公式読みベース) |
| [`core/works/anime/gintama.toml`](core/works/anime/gintama.toml) | 12 | 1.2 KB | 銀魂 (空知英秋): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/onepiece.toml`](core/works/anime/onepiece.toml) | 11 | 929 B | ONE PIECE (尾田栄一郎): キャラクター名 / 用語 |
| [`core/works/anime/bluelock.toml`](core/works/anime/bluelock.toml) | 9 | 856 B | ブルーロック (金城宗幸/ノ村優介): キャラクター名 |
...
| [`core/works/anime/kurobas.toml`](core/works/anime/kurobas.toml) | 5 | 617 B | 黒子のバスケ (藤巻忠俊): キャラクター名 |
...
| [`core/works/anime/heroaca.toml`](core/works/anime/heroaca.toml) | 3 | 523 B | 僕のヒーローアカデミア (堀越耕平): キャラクター名 (公式読みベース) |
| [`core/works/anime/yuyuhakusho.toml`](core/works/anime/yuyuhakusho.toml) | 3 | 376 B | 幽☆遊☆白書 (冨樫義博): キャラクター名 |
...
| [`core/works/anime/oshinoko.toml`](core/works/anime/oshinoko.toml) | 2 | 372 B | 【推しの子】 (赤坂アカ/横槍メンゴ): キャラクター名 |
...
| [`core/works/anime/inuyasha.toml`](core/works/anime/inuyasha.toml) | 1 | 206 B | 犬夜叉 (高橋留美子): キャラクター名 |
...
| **小計** (36 ファイル) | **231** | **24 KB** | |

#### VTuber

VTuber の名前 (姓・フルネーム、 公式読みベース)

`core/works/vtuber/` — 3 ファイル

| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/vtuber/hololive.toml`](core/works/vtuber/hololive.toml) | 31 | 2.7 KB | ホロライブプロダクション (カバー): タレント名 (公式読みベース) |
| [`core/works/vtuber/nijisanji.toml`](core/works/vtuber/nijisanji.toml) | 29 | 2.6 KB | にじさんじ (ANYCOLOR): ライバー名 (公式読みベース) |
| [`core/works/vtuber/vspo.toml`](core/works/vtuber/vspo.toml) | 4 | 466 B | ぶいすぽっ! : タレント名 (公式読みベース) |
| **小計** (3 ファイル) | **64** | **5.8 KB** | |
...
**合計**: should_read 1959 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/probe_bakumatsu_20260619.toml`](tests/corpus/should_read/probe_bakumatsu_20260619.toml) | 6 |
...
|  | [`tests/corpus/should_read/probe_sumo2_20260619.toml`](tests/corpus/should_read/probe_sumo2_20260619.toml) | 7 |
