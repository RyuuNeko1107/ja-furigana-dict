...
**合計**: 672 エントリ / 757 ルール / 29 KB (genre 3 区分)
...
|---|---:|---:|---:|---|
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 58 | 124 | 12 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
| [`rules/numbers/counters/simple.toml`](rules/numbers/counters/simple.toml) | 50 | 50 | 1.2 KB | 単純サフィックス助数詞 (円 / 点 / 度 / 名 / 話 等、 数値カナ + value 連結のみ) |
...
**合計**: should_read 1538 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/probe_counter2_20260619.toml`](tests/corpus/should_read/probe_counter2_20260619.toml) | 12 |
