...
| **熟語** (`core/jukugo/*`、手動 PR メンテ) | **4,351** | **181 KB** |
...
| `core/jukugo/general.toml` | 739 | 21 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
| `core/jukugo/personal_names.toml` | 214 | 9.8 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
| `core/jukugo/colors.toml` | 201 | 7.3 KB | 色名 / 染色 / 模様 / 古典色 / 鉱物色 |
| `core/jukugo/proper_nouns.toml` | 193 | 10 KB | 固有名詞 (大学 / 中央官庁 / 元号 / 歴史的事象、PR 募集中) |
| `core/jukugo/animals.toml` | 186 | 5.9 KB | 動植物 / 魚介 / 鳥 / 昆虫 / 茸 / 海藻の難読 |
| `core/jukugo/music.toml` | 180 | 11 KB | 音楽ジャンル / 楽典 / 楽器 / 演奏 / 音楽用語 |
| `core/jukugo/arts.toml` | 178 | 10 KB | 古典芸能 / 武道 / 茶華香 / 工芸 |
| `core/jukugo/body_parts.toml` | 163 | 5.8 KB | 体の部位 / 内臓 / 骨格 / 筋肉 / 神経 |
| `core/jukugo/place_names.toml` | 163 | 5.7 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
| `core/jukugo/religions.toml` | 154 | 6.0 KB | 神道 / 仏教 / キリスト教 / イスラム / 儀礼 |
| `core/jukugo/abstracts.toml` | 152 | 5.4 KB | 美意識 / 古典文学 / 仏教 / 儒教 / 思想 |
...
| `core/jukugo/specialized.toml` | 145 | 5.7 KB | 専門用語 (医学 / 軍事 / 法学 / 経済 / IT / 工学) |
| `core/jukugo/sports.toml` | 144 | 9.4 KB | 近代スポーツ / 球技 / 陸上 / 水泳 / 体操 / 大会 |
| `core/jukugo/architecture.toml` | 143 | 8.8 KB | 建築 / 建造物 / 寺社建築 / 城郭 / 庭園 |
| `core/jukugo/foods.toml` | 141 | 4.9 KB | 食べ物 / 料理 / 和菓子 / 郷土料理 / 食材 / 調味料 |
| `core/jukugo/four_char.toml` | 141 | 6.5 KB | 四字熟語 (4 字 + 全 CJK 漢字) |
| `core/jukugo/vehicles.toml` | 137 | 5.2 KB | 乗り物 / 交通手段 / 船舶 / 航空 / 鉄道 |
| `core/jukugo/weather.toml` | 137 | 5.1 KB | 気象 / 天候 / 季語的気象 / 二十四節気 / 海洋気象 |
| `core/jukugo/science.toml` | 136 | 5.3 KB | 自然科学 (天文 / 物理 / 化学 / 生物 / 地学) |
| `core/jukugo/clothes.toml` | 135 | 4.4 KB | 衣服 / 装束 / アクセサリー / 履物 |
| `core/jukugo/idioms.toml` | 122 | 7.1 KB | 慣用句 / ことわざ / 故事成語 (フレーズ単位) |
| `core/works/game/touhou.toml` | 72 | 4.7 KB | 東方Project (上海アリス幻樂団): キャラクター名 / 場所 / 用語 (公式読みベース) |
| `core/compat.toml` | 436 | 6.3 KB | 異体字 → 標準字 (髙→高 等) |
| **小計** | **48,608** | **988 KB** | (jukugo: 24 ファイル / **4,351 件** / 181 KB ・ works: 1 ファイル / **72 件** / 4.7 KB) |
