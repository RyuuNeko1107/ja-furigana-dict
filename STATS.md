...
| カテゴリ | エントリ数 | サイズ |
|---|---:|---:|
| [**単漢字**](#単漢字) (`core/unihan/*`、 水準別 5 ファイル) | **40,681** | **739 KB** |
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **2,965** | **156 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **311** | **10 KB** |
| [**外来語**](#外来語) (`core/loanwords/*`、IT 用語等の英字 surface) | **725** | **19 KB** |
| [**分類前 inbox**](#分類前-inbox) (`core/_inbox.toml`、 後で振り分ける一時置き場) | **0** | **180 B** |
| [**単漢字 [[kanji]] format**](#単漢字-kanji-format) (`core/kanji/*`、 default + 文脈分岐 reading) | **2,770** | **181 KB** |
...
| [`core/unihan/jis_basic.toml`](core/unihan/jis_basic.toml) | 13,044 | 236 KB | JIS 基本 (CJK Basic Block U+4E00-U+9FFF のうち常用 / 人名用以外、 概ね JIS X 0208 第1+第2水準カバー) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/humanities/arts.toml`](core/jukugo/humanities/arts.toml) | 58 | 2.1 KB | 古典芸能 / 武道 / 茶華香 / 工芸 |
...
| [`core/jukugo/objects/vehicles.toml`](core/jukugo/objects/vehicles.toml) | 22 | 886 B | 乗り物 / 交通手段 / 船舶 / 航空 / 鉄道 |
| [`core/jukugo/objects/railway.toml`](core/jukugo/objects/railway.toml) | 6 | 341 B | 鉄道専門用語 (線路 / 駅 / 運行 / 車両) |
| **小計** (5 ファイル) | **181** | **6.1 KB** | |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,029 | 117 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
| [`core/jukugo/basic/stream_round_20260526.toml`](core/jukugo/basic/stream_round_20260526.toml) | 31 | 1.0 KB | VV stream-comments comparison round (seed=20260526) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 15 | 729 B | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (3 ファイル) | **2,075** | **119 KB** | |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/loanwords/general.toml`](core/loanwords/general.toml) | 543 | 14 KB | 一般英語 / メディア / ゲーミング / SNS 略語 (ASCII surface) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,770 | 3,599 | 181 KB | 単漢字 default override + 文脈分岐 reading |
