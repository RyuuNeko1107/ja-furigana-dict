...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,074** | **164 KB** |
...
| [`core/jukugo/basic/stream_round_20260611.toml`](core/jukugo/basic/stream_round_20260611.toml) | 13 | 1.3 KB | VV stream-comments comparison round (seed=20260611) |
| **小計** (4 ファイル) | **2,167** | **125 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,557 | 177 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: 229 エントリ / 275 ルール / 13 KB (genre 2 区分)
...
|---|---:|---:|---:|---|
| [`rules/numbers/counters/simple.toml`](rules/numbers/counters/simple.toml) | 81 | 81 | 1.8 KB | 単純サフィックス助数詞 (円 / 点 / 度 / 名 / 話 等、 数値カナ + value 連結のみ) |
...
**合計**: should_read 840 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/regression.toml`](tests/corpus/should_read/regression.toml) | 447 |
