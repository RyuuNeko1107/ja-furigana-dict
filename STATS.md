...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,877** | **203 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **527** | **33 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 170 | 13 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 91 | 6.2 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
| [`core/jukugo/proper/proper_nouns.toml`](core/jukugo/proper/proper_nouns.toml) | 30 | 1.5 KB | 固有名詞 (大学 / 中央官庁 / 元号 / 歴史的事象、PR 募集中) |
| **小計** (2 ファイル) | **121** | **7.7 KB** | |
...
**合計**: 527 件 / 33 KB (genre 4 区分)

#### ゲーム

ゲーム作品の固有名詞 (キャラクター / 場所 / 用語、 公式読みベース)

`core/works/game/` — 8 ファイル
...
**合計**: should_read 1822 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
