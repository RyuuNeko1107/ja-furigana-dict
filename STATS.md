...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,573** | **242 KB** |
...
**合計**: should_read 2448 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/probe_genbun_20260620.toml`](tests/corpus/should_read/probe_genbun_20260620.toml) | 90 |
