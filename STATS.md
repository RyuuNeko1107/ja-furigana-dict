...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,933** | **207 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 194 | 15 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
`core/works/anime/` — 28 ファイル

| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/anime/bleach.toml`](core/works/anime/bleach.toml) | 19 | 1.8 KB | BLEACH (久保帯人) キャラ名・用語 |
| [`core/works/anime/jujutsu.toml`](core/works/anime/jujutsu.toml) | 16 | 1.5 KB | 呪術廻戦 (芥見下々): キャラクター名 / 用語 (公式読みベース) |
...
**合計**: should_read 1886 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/probe_chugoku2_20260619.toml`](tests/corpus/should_read/probe_chugoku2_20260619.toml) | 5 |
