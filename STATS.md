...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 188 | 14 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| [`core/jukugo/proper/sumo_shikona.toml`](core/jukugo/proper/sumo_shikona.toml) | 21 | 1.6 KB | 大相撲 力士の四股名 (公式読み) |
| **小計** (3 ファイル) | **153** | **10 KB** | |
...
**合計**: should_read 1881 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
