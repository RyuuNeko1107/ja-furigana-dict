...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **17,820** | **692 KB** |
...
| [`core/jukugo/proper/surnames.toml`](core/jukugo/proper/surnames.toml) | 61 | 3.2 KB | 難読姓 (苗字) の読み (姓単体、代表読み) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 4,484 | 214 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 35 | 2.3 KB | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (2 ファイル) | **4,519** | **216 KB** | |
...
**合計**: 704 エントリ / 807 ルール / 35 KB (genre 3 区分)
...
**合計**: should_read 3942 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
