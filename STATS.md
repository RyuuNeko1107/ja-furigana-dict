...
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **907** | **66 KB** |
...
**合計**: 907 件 / 66 KB (genre 4 区分)

#### ゲーム

ゲーム作品の固有名詞 (キャラクター / 場所 / 用語、 公式読みベース)

`core/works/game/` — 19 ファイル
...
**合計**: should_read 2054 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
