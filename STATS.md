...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,701** | **188 KB** |
...
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 45 | 2.2 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| [`core/jukugo/society/politics.toml`](core/jukugo/society/politics.toml) | 9 | 810 B | 政治 / 行政 / 立法 / 司法 / 国際関係 |
| **小計** (4 ファイル) | **125** | **7.6 KB** | |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,581 | 135 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 29 | 1.8 KB | 四字熟語 (4 字 + 全 CJK 漢字) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,621 | 182 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: 672 エントリ / 742 ルール / 27 KB (genre 3 区分)
...
|---|---:|---:|---:|---|
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 42 | 93 | 9.7 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
| [`rules/numbers/counters/simple.toml`](rules/numbers/counters/simple.toml) | 66 | 66 | 1.4 KB | 単純サフィックス助数詞 (円 / 点 / 度 / 名 / 話 等、 数値カナ + value 連結のみ) |
...
**合計**: should_read 1526 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
| テストファイル | 対象本体 | ケース数 |
|---|---|---:|
| [`rules/numbers/counters/objects.test.toml`](rules/numbers/counters/objects.test.toml) | [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 11 |
