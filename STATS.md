...
| [**外来語**](#外来語) (`core/loanwords/*`、IT 用語等の英字 surface) | **652** | **17 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/loanwords/general.toml`](core/loanwords/general.toml) | 471 | 12 KB | 一般英語 / メディア / ゲーミング / SNS 略語 (ASCII surface) |
