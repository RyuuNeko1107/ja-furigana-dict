...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **2,996** | **157 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **314** | **11 KB** |
| [**外来語**](#外来語) (`core/loanwords/*`、IT 用語等の英字 surface) | **739** | **20 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,052 | 118 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,597 | 181 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: should_read 765 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/regression.toml`](tests/corpus/should_read/regression.toml) | 372 |
