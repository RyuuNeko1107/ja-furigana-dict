...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,013** | **158 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **314** | **11 KB** |
| [**外来語**](#外来語) (`core/loanwords/*`、IT 用語等の英字 surface) | **741** | **20 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,069 | 119 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
| [`core/loanwords/it.toml`](core/loanwords/it.toml) | 184 | 5.6 KB | IT 用語 / プログラミング言語 / OSS / クラウドサービス / 技術企業 (ASCII surface) |
| **小計** (2 ファイル) | **741** | **20 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,556 | 176 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: should_read 801 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/regression.toml`](tests/corpus/should_read/regression.toml) | 408 |
