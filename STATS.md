...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,087** | **165 KB** |
...
| [**単漢字 [[kanji]] format**](#単漢字-kanji-format) (`core/kanji/*`、 default + 文脈分岐 reading) | **2,771** | **179 KB** |
...
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 41 | 1.7 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/humanities/arts.toml`](core/jukugo/humanities/arts.toml) | 57 | 2.1 KB | 古典芸能 / 武道 / 茶華香 / 工芸 |
...
`core/works/vtuber/` — 1 ファイル

| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/vtuber/hololive.toml`](core/works/vtuber/hololive.toml) | 9 | 926 B | ホロライブプロダクション (カバー): タレント名 (公式読みベース) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,576 | 179 KB | 単漢字 default override + 文脈分岐 reading |
...
|---|---:|---:|---:|---|
| [`rules/numbers/counters/simple.toml`](rules/numbers/counters/simple.toml) | 78 | 78 | 1.7 KB | 単純サフィックス助数詞 (円 / 点 / 度 / 名 / 話 等、 数値カナ + value 連結のみ) |
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 27 | 62 | 5.7 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
...
**合計**: should_read 892 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
