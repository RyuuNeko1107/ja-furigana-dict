...
| [`core/jukugo/proper/surnames.toml`](core/jukugo/proper/surnames.toml) | 45 | 1.6 KB | 難読姓 (苗字) の読み (姓単体、代表読み) |
...
**合計**: should_read 2271 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
