...
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **1,484** | **111 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/anime/_minor.toml`](core/works/anime/_minor.toml) | 65 | 5.6 KB | アニメ/漫画 小規模作品 統合 (1作品1-3語、2026-06-21 consolidate) |
...
| [`core/works/anime/bleach.toml`](core/works/anime/bleach.toml) | 28 | 2.5 KB | BLEACH (久保帯人) キャラ名・用語 |
...
| [`core/works/anime/toaru.toml`](core/works/anime/toaru.toml) | 9 | 1003 B | とある魔術の禁書目録 / 超電磁砲 (鎌池和馬): キャラクター名 |
