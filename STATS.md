...
| [**分類前 inbox**](#分類前-inbox) (`core/_inbox.toml`、 後で振り分ける一時置き場) | **340** | **17 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/_inbox.toml`](core/_inbox.toml) | 340 | 17 KB | 分類前の一時 inbox (≥2 字 surface、 内容が貯まったら適切な genre dir に振り分ける) |
...
**合計**: should_read 11577 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/probe_20260924_cur_misread2.toml`](tests/corpus/should_read/probe_20260924_cur_misread2.toml) | 182 |
