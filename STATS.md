...
| [**外来語**](#外来語) (`core/loanwords/*`、IT 用語等の英字 surface) | **236** | **7.2 KB** |
...
| [`core/loanwords/general.toml`](core/loanwords/general.toml) | 55 | 1.6 KB | 一般英語 / メディア / ゲーミング / SNS 略語 (ASCII surface) |
| **小計** (2 ファイル) | **236** | **7.2 KB** | |
