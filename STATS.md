...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **17,522** | **681 KB** |
...
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 816 | 37 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| [`core/jukugo/humanities/idioms.toml`](core/jukugo/humanities/idioms.toml) | 91 | 5.2 KB | 慣用句 / ことわざ / 故事成語 (フレーズ単位) |
...
| [`core/jukugo/proper/surnames.toml`](core/jukugo/proper/surnames.toml) | 52 | 3.4 KB | 難読姓 (苗字) の読み (姓単体、代表読み) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 4,228 | 205 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 35 | 2.3 KB | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (2 ファイル) | **4,263** | **207 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,773 | 3,746 | 192 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: should_read 3337 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
