...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,594** | **180 KB** |
...
| [**エンジンルール**](#エンジンルール) (`rules/`) | **672** | **27 KB** |
| **合計** | **48,855** | **1.14 MB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,497 | 130 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,612 | 181 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: 672 エントリ / 739 ルール / 27 KB (genre 3 区分)
...
|---|---:|---:|---:|---|
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 40 | 88 | 9.4 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
| [`rules/numbers/counters/simple.toml`](rules/numbers/counters/simple.toml) | 68 | 68 | 1.5 KB | 単純サフィックス助数詞 (円 / 点 / 度 / 名 / 話 等、 数値カナ + value 連結のみ) |
...
**合計**: should_read 1299 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
