...
| テストファイル | 対象本体 | ケース数 |
|---|---|---:|
| [`rules/numbers/counters/objects.test.toml`](rules/numbers/counters/objects.test.toml) | [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 6 |
