...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 166 | 12 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
...
| [`core/works/game/idolmaster.toml`](core/works/game/idolmaster.toml) | 52 | 4.2 KB | アイドルマスター (バンダイナムコ): キャラクター名 |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/vtuber/nijisanji.toml`](core/works/vtuber/nijisanji.toml) | 49 | 4.1 KB | にじさんじ (ANYCOLOR): ライバー名 (公式読みベース) |
...
**合計**: should_read 2248 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
