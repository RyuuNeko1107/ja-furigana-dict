...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,247** | **220 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **851** | **61 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/humanities/arts.toml`](core/jukugo/humanities/arts.toml) | 64 | 2.7 KB | 古典芸能 / 武道 / 茶華香 / 工芸 |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 104 | 7.4 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
...
| [`core/works/anime/ghibli.toml`](core/works/anime/ghibli.toml) | 6 | 623 B | スタジオジブリ: キャラクター名 / 用語 / 作品名 |
...
**合計**: should_read 2032 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
