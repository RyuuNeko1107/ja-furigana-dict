...
| [`core/jukugo/basic/stream_round_20260611.toml`](core/jukugo/basic/stream_round_20260611.toml) | 16 | 1.6 KB | VV stream-comments comparison round (seed=20260611) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 15 | 729 B | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (4 ファイル) | **2,170** | **126 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,558 | 177 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: should_read 854 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/regression.toml`](tests/corpus/should_read/regression.toml) | 461 |
