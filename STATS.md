...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **17,769** | **690 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 266 | 17 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
| [`core/jukugo/proper/surnames.toml`](core/jukugo/proper/surnames.toml) | 54 | 3.0 KB | 難読姓 (苗字) の読み (姓単体、代表読み) |
...
**合計**: should_read 3767 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
