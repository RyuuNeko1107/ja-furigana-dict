...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,573** | **179 KB** |
...
| [**単漢字 [[kanji]] format**](#単漢字-kanji-format) (`core/kanji/*`、 default + 文脈分岐 reading) | **2,771** | **181 KB** |
| [**異体字**](#異体字) (`core/compat.toml`) | **0** | **0 B** |
| [**エンジンルール**](#エンジンルール) (`rules/`) | **661** | **24 KB** |
| **合計** | **48,823** | **1.14 MB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,476 | 129 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,605 | 181 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: 661 エントリ / 715 ルール / 24 KB (genre 3 区分)
...
|---|---:|---:|---:|---|
| [`rules/numbers/counters/simple.toml`](rules/numbers/counters/simple.toml) | 69 | 69 | 1.5 KB | 単純サフィックス助数詞 (円 / 点 / 度 / 名 / 話 等、 数値カナ + value 連結のみ) |
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 28 | 63 | 6.6 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
...
**合計**: should_read 1195 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
