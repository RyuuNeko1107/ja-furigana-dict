...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,787** | **255 KB** |
...
| [**単漢字 [[kanji]] format**](#単漢字-kanji-format) (`core/kanji/*`、 default + 文脈分岐 reading) | **2,771** | **186 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 239 | 18 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,912 | 156 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/loanwords/general.toml`](core/loanwords/general.toml) | 758 | 19 KB | 一般英語 / メディア / ゲーミング / SNS 略語 (ASCII surface) |
| [`core/loanwords/it.toml`](core/loanwords/it.toml) | 213 | 6.7 KB | IT 用語 / プログラミング言語 / OSS / クラウドサービス / 技術企業 (ASCII surface) |
| **小計** (2 ファイル) | **971** | **26 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,671 | 186 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: 678 エントリ / 772 ルール / 30 KB (genre 3 区分)
...
|---|---:|---:|---:|---|
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 68 | 143 | 13 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
| [`rules/numbers/counters/simple.toml`](rules/numbers/counters/simple.toml) | 46 | 46 | 1.1 KB | 単純サフィックス助数詞 (円 / 点 / 度 / 名 / 話 等、 数値カナ + value 連結のみ) |
...
**合計**: should_read 2537 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/probe_genbun_20260620.toml`](tests/corpus/should_read/probe_genbun_20260620.toml) | 157 |
...
|  | [`tests/corpus/should_read/probe_r186190_20260619.toml`](tests/corpus/should_read/probe_r186190_20260619.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r191195_20260619.toml`](tests/corpus/should_read/probe_r191195_20260619.toml) | 6 |
|  | [`tests/corpus/should_read/probe_r196200_20260619.toml`](tests/corpus/should_read/probe_r196200_20260619.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r201205_20260619.toml`](tests/corpus/should_read/probe_r201205_20260619.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r206209_20260619.toml`](tests/corpus/should_read/probe_r206209_20260619.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r210_20260619.toml`](tests/corpus/should_read/probe_r210_20260619.toml) | 2 |
|  | [`tests/corpus/should_read/probe_r211214_20260619.toml`](tests/corpus/should_read/probe_r211214_20260619.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r215218_20260619.toml`](tests/corpus/should_read/probe_r215218_20260619.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r219223_20260619.toml`](tests/corpus/should_read/probe_r219223_20260619.toml) | 6 |
|  | [`tests/corpus/should_read/probe_r224227_20260619.toml`](tests/corpus/should_read/probe_r224227_20260619.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r228231_20260619.toml`](tests/corpus/should_read/probe_r228231_20260619.toml) | 6 |
|  | [`tests/corpus/should_read/probe_r232235_20260620.toml`](tests/corpus/should_read/probe_r232235_20260620.toml) | 6 |
|  | [`tests/corpus/should_read/probe_r236239_20260620.toml`](tests/corpus/should_read/probe_r236239_20260620.toml) | 6 |
|  | [`tests/corpus/should_read/probe_r240243_20260620.toml`](tests/corpus/should_read/probe_r240243_20260620.toml) | 6 |
|  | [`tests/corpus/should_read/probe_r244247_20260620.toml`](tests/corpus/should_read/probe_r244247_20260620.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r248249_sent_20260620.toml`](tests/corpus/should_read/probe_r248249_sent_20260620.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r250251_sent_20260620.toml`](tests/corpus/should_read/probe_r250251_sent_20260620.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r252253_sent_20260620.toml`](tests/corpus/should_read/probe_r252253_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r254255_sent_20260620.toml`](tests/corpus/should_read/probe_r254255_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r256_sent_20260620.toml`](tests/corpus/should_read/probe_r256_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r257258_sent_20260620.toml`](tests/corpus/should_read/probe_r257258_sent_20260620.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r259260_sent_20260620.toml`](tests/corpus/should_read/probe_r259260_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r261262_sent_20260620.toml`](tests/corpus/should_read/probe_r261262_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r263_sent_20260620.toml`](tests/corpus/should_read/probe_r263_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r264_sent_20260620.toml`](tests/corpus/should_read/probe_r264_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r266_sent_20260620.toml`](tests/corpus/should_read/probe_r266_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r267271_sent_20260620.toml`](tests/corpus/should_read/probe_r267271_sent_20260620.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r272274_sent_20260620.toml`](tests/corpus/should_read/probe_r272274_sent_20260620.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r275277_sent_20260620.toml`](tests/corpus/should_read/probe_r275277_sent_20260620.toml) | 3 |
|  | [`tests/corpus/should_read/probe_r278279_sent_20260620.toml`](tests/corpus/should_read/probe_r278279_sent_20260620.toml) | 5 |
|  | [`tests/corpus/should_read/probe_r280281_sent_20260620.toml`](tests/corpus/should_read/probe_r280281_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r282_sent_20260620.toml`](tests/corpus/should_read/probe_r282_sent_20260620.toml) | 4 |
|  | [`tests/corpus/should_read/probe_r283284_sent_20260620.toml`](tests/corpus/should_read/probe_r283284_sent_20260620.toml) | 3 |
...
|  | [`tests/corpus/should_read/probe_vvcmp_20260620.toml`](tests/corpus/should_read/probe_vvcmp_20260620.toml) | 22 |
