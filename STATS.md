...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **2,974** | **156 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **312** | **10 KB** |
| [**外来語**](#外来語) (`core/loanwords/*`、IT 用語等の英字 surface) | **730** | **19 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,030 | 117 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/loanwords/general.toml`](core/loanwords/general.toml) | 548 | 14 KB | 一般英語 / メディア / ゲーミング / SNS 略語 (ASCII surface) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,605 | 182 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: should_read 708 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース

| バケット | ファイル | ケース数 |
|---|---|---:|
| `should_read` | [`tests/corpus/should_read/extended.toml`](tests/corpus/should_read/extended.toml) | 94 |
|  | [`tests/corpus/should_read/general.toml`](tests/corpus/should_read/general.toml) | 45 |
