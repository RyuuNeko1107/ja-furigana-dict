...
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **1,290** | **97 KB** |
...
| [`core/works/game/idolmaster.toml`](core/works/game/idolmaster.toml) | 41 | 3.4 KB | アイドルマスター (バンダイナムコ): キャラクター名 |
...
**合計**: should_read 2242 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
