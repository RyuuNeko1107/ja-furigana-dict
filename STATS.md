...
| カテゴリ | エントリ数 | サイズ |
|---|---:|---:|
| [**単漢字**](#単漢字) (`core/unihan/*`、 水準別 5 ファイル) | **40,679** | **739 KB** |
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **17,203** | **661 KB** |
...
| [**単漢字 [[kanji]] format**](#単漢字-kanji-format) (`core/kanji/*`、 default + 文脈分岐 reading) | **2,772** | **188 KB** |
...
| [`core/unihan/jis_basic.toml`](core/unihan/jis_basic.toml) | 13,042 | 236 KB | JIS 基本 (CJK Basic Block U+4E00-U+9FFF のうち常用 / 人名用以外、 概ね JIS X 0208 第1+第2水準カバー) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/humanities/arts.toml`](core/jukugo/humanities/arts.toml) | 2,779 | 92 KB | 古典芸能 / 武道 / 茶華香 / 工芸 |
...
| [`core/jukugo/humanities/idioms.toml`](core/jukugo/humanities/idioms.toml) | 44 | 2.9 KB | 慣用句 / ことわざ / 故事成語 (フレーズ単位) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,772 | 3,685 | 188 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: should_read 2845 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
