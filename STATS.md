...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,372** | **228 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **1,080** | **80 KB** |
...
| [`core/jukugo/proper/surnames.toml`](core/jukugo/proper/surnames.toml) | 41 | 1.4 KB | 難読姓 (苗字) の読み (姓単体、代表読み) |
...
**合計**: should_read 2154 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
