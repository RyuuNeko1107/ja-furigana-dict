...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,580** | **180 KB** |
...
| [**エンジンルール**](#エンジンルール) (`rules/`) | **663** | **25 KB** |
| **合計** | **48,832** | **1.14 MB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,483 | 129 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,607 | 181 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: 663 エントリ / 721 ルール / 25 KB (genre 3 区分)
...
|---|---:|---:|---:|---|
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 31 | 70 | 7.4 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
...
**合計**: should_read 1228 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
