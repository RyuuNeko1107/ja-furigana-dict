...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,228** | **218 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **671** | **47 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 210 | 16 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| [`core/works/anime/tokyoghoul.toml`](core/works/anime/tokyoghoul.toml) | 7 | 693 B | 東京喰種 (石田スイ): キャラクター名 / 用語 |
...
| [`core/works/vtuber/nijisanji.toml`](core/works/vtuber/nijisanji.toml) | 21 | 1.9 KB | にじさんじ (ANYCOLOR): ライバー名 (公式読みベース) |
...
**合計**: should_read 1937 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
