...
| [**外来語**](#外来語) (`core/loanwords/*`、IT 用語等の英字 surface) | **721** | **19 KB** |
| [**分類前 inbox**](#分類前-inbox) (`core/_inbox.toml`、 後で振り分ける一時置き場) | **0** | **180 B** |
| [**単漢字 [[kanji]] format**](#単漢字-kanji-format) (`core/kanji/*`、 default + 文脈分岐 reading) | **2,770** | **175 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/loanwords/general.toml`](core/loanwords/general.toml) | 540 | 14 KB | 一般英語 / メディア / ゲーミング / SNS 略語 (ASCII surface) |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,770 | 3,507 | 175 KB | 単漢字 default override + 文脈分岐 reading |
