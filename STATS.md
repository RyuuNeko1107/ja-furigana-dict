...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **8,444** | **283 KB** |
...
| [`core/jukugo/nature/animals.toml`](core/jukugo/nature/animals.toml) | 188 | 5.0 KB | 動植物 / 魚介 / 鳥 / 昆虫 / 茸 / 海藻の難読 |
...
| [`core/jukugo/nature/foods.toml`](core/jukugo/nature/foods.toml) | 164 | 4.8 KB | 食べ物 / 料理 / 和菓子 / 郷土料理 / 食材 / 調味料 |
| **小計** (6 ファイル) | **1,065** | **31 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,767 | 3,591 | 185 KB | 単漢字 default override + 文脈分岐 reading |
