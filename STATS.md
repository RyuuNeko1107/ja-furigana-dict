...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,267** | **222 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **883** | **64 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 124 | 8.9 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
...
**合計**: 883 件 / 64 KB (genre 4 区分)

#### ゲーム

ゲーム作品の固有名詞 (キャラクター / 場所 / 用語、 公式読みベース)

`core/works/game/` — 18 ファイル
...
**合計**: should_read 2048 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
