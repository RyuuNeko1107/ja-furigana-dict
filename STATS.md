...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,076** | **164 KB** |
...
| [`core/jukugo/basic/stream_round_20260611.toml`](core/jukugo/basic/stream_round_20260611.toml) | 15 | 1.5 KB | VV stream-comments comparison round (seed=20260611) |
| **小計** (4 ファイル) | **2,169** | **126 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,556 | 177 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: should_read 845 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/regression.toml`](tests/corpus/should_read/regression.toml) | 452 |
