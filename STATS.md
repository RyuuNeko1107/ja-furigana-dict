...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,517** | **238 KB** |
...
**合計**: should_read 2377 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/probe_genbun_20260620.toml`](tests/corpus/should_read/probe_genbun_20260620.toml) | 19 |
