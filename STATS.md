...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **2,681** | **121 KB** |
...
| [`core/unihan/jis_basic.toml`](core/unihan/jis_basic.toml) | 13,047 | 236 KB | JIS 基本 (CJK Basic Block U+4E00-U+9FFF のうち常用 / 人名用以外、 概ね JIS X 0208 第1+第2水準カバー) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/foods.toml`](core/jukugo/nature/foods.toml) | 88 | 2.9 KB | 食べ物 / 料理 / 和菓子 / 郷土料理 / 食材 / 調味料 |
...
| [`core/jukugo/humanities/abstracts.toml`](core/jukugo/humanities/abstracts.toml) | 17 | 665 B | 美意識 / 古典文学 / 仏教 / 儒教 / 思想 |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 1,756 | 84 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 13 | 653 B | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (2 ファイル) | **1,769** | **85 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,767 | 3,591 | 186 KB | 単漢字 default override + 文脈分岐 reading |
