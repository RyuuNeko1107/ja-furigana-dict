...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **17,107** | **653 KB** |
...
| [`core/jukugo/proper/surnames.toml`](core/jukugo/proper/surnames.toml) | 45 | 1.7 KB | 難読姓 (苗字) の読み (姓単体、代表読み) |
...
**合計**: should_read 2739 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
