...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **17,796** | **691 KB** |
...
| [`core/unihan/jis_basic.toml`](core/unihan/jis_basic.toml) | 13,037 | 235 KB | JIS 基本 (CJK Basic Block U+4E00-U+9FFF のうち常用 / 人名用以外、 概ね JIS X 0208 第1+第2水準カバー) |
...
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 817 | 37 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
| [`core/jukugo/nature/foods.toml`](core/jukugo/nature/foods.toml) | 497 | 17 KB | 食べ物 / 料理 / 和菓子 / 郷土料理 / 食材 / 調味料 |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 273 | 17 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
| [`core/jukugo/proper/surnames.toml`](core/jukugo/proper/surnames.toml) | 60 | 3.2 KB | 難読姓 (苗字) の読み (姓単体、代表読み) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 4,461 | 213 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 35 | 2.3 KB | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (2 ファイル) | **4,496** | **215 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,773 | 3,786 | 194 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: should_read 3839 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/probe_20260914_katakana_suffix.toml`](tests/corpus/should_read/probe_20260914_katakana_suffix.toml) | 0 |
