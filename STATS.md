...
| [**エンジンルール**](#エンジンルール) (`rules/`) | **226** | **14 KB** |
| **合計** | **48,276** | **1.11 MB** |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,771 | 3,559 | 177 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: 226 エントリ / 272 ルール / 14 KB (genre 2 区分)
...
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 27 | 62 | 4.9 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
...
**合計**: should_read 878 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/regression.toml`](tests/corpus/should_read/regression.toml) | 485 |
