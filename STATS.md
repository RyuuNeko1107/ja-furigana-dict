...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,469** | **236 KB** |
...
| [`core/jukugo/proper/surnames.toml`](core/jukugo/proper/surnames.toml) | 47 | 1.7 KB | 難読姓 (苗字) の読み (姓単体、代表読み) |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 2,612 | 137 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
...
**合計**: should_read 2321 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
