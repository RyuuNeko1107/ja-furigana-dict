...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **18,290** | **728 KB** |
...
| [**単漢字 [[kanji]] format**](#単漢字-kanji-format) (`core/kanji/*`、 default + 文脈分岐 reading) | **2,773** | **205 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/basic/general.toml`](core/jukugo/basic/general.toml) | 4,856 | 226 KB | 二字・三字の一般熟語 (季節 / 行事 / 慣用句 含む) |
| [`core/jukugo/basic/four_char.toml`](core/jukugo/basic/four_char.toml) | 35 | 2.3 KB | 四字熟語 (4 字 + 全 CJK 漢字) |
| **小計** (2 ファイル) | **4,891** | **229 KB** | |
...
|---|---:|---:|---:|---|
| [`core/kanji/overrides.toml`](core/kanji/overrides.toml) | 2,773 | 3,882 | 205 KB | 単漢字 default override + 文脈分岐 reading |
...
**合計**: should_read 4304 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
