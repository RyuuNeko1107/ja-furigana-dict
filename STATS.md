...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,433** | **233 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **1,266** | **95 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/proper/personal_names.toml`](core/jukugo/proper/personal_names.toml) | 164 | 12 KB | 人名 (戦国 / 平安 / 江戸 / 明治大正 / 古典作家、現代私人除く) |
...
| [`core/works/game/idolmaster.toml`](core/works/game/idolmaster.toml) | 17 | 1.5 KB | アイドルマスター (バンダイナムコ): キャラクター名 |
...
**合計**: should_read 2237 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
