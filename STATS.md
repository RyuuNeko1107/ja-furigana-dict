...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **3,066** | **163 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **332** | **13 KB** |
...
| [`core/jukugo/basic/stream_round_20260611.toml`](core/jukugo/basic/stream_round_20260611.toml) | 7 | 700 B | VV stream-comments comparison round (seed=20260611) |
| **小計** (4 ファイル) | **2,161** | **125 KB** | |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/works/vtuber/hololive.toml`](core/works/vtuber/hololive.toml) | 8 | 824 B | ホロライブプロダクション (カバー): タレント名 (公式読みベース) |
...
**合計**: should_read 817 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/regression.toml`](tests/corpus/should_read/regression.toml) | 424 |
