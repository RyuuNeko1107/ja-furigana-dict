...
**合計**: 179 エントリ / 201 ルール / 9.7 KB (genre 2 区分)
...
| [`rules/numbers/counters/objects.toml`](rules/numbers/counters/objects.toml) | 7 | 18 | 1.2 KB | 物を数える助数詞 (本 / 匹 / 杯 / 個 / 歳 / 冊、 連濁 / 促音化) |
...
**合計**: should_read 598 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
...
|  | [`tests/corpus/should_read/regression.toml`](tests/corpus/should_read/regression.toml) | 242 |
