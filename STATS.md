...
| [**熟語**](#熟語) (`core/jukugo/*`、手動 PR メンテ) | **4,217** | **218 KB** |
| [**作品造語**](#作品造語) (`core/works/*`、作品単位 1 ファイル) | **625** | **42 KB** |
...
| ファイル | エントリ数 | サイズ | 用途 |
|---|---:|---:|---|
| [`core/jukugo/nature/place_names.toml`](core/jukugo/nature/place_names.toml) | 199 | 15 KB | 地名 (47 都道府県 / 主要都市 / 駅 / 寺社仏閣 / 観光地) |
...
| [`core/works/anime/kimetsu.toml`](core/works/anime/kimetsu.toml) | 14 | 1.4 KB | 鬼滅の刃 (吾峠呼世晴): キャラクター名 / 用語 (公式読みベース) |
| [`core/works/anime/onepiece.toml`](core/works/anime/onepiece.toml) | 11 | 929 B | ONE PIECE (尾田栄一郎): キャラクター名 / 用語 |
| [`core/works/anime/bluelock.toml`](core/works/anime/bluelock.toml) | 10 | 946 B | ブルーロック (金城宗幸/ノ村優介): キャラクター名 |
...
**合計**: should_read 1908 ケース / should_not_read_yet 1 ケース / out_of_scope 0 ケース
